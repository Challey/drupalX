...
function dx_portal_theme_login_i18n_strings($langcode = NULL) {
  ...
  $catalog = [
    'en' => [
      'sign_in' => 'Unified sign-in',
      'unified_login' => 'Unified sign-in',
      'unified_login_sub' => 'One identity entry for China and worldwide',
      ...
      'company_label' => 'Company',
      'sign_up' => 'First email login creates an account',
      'account_auto_hint' => 'Existing accounts sign in; a new email is registered automatically.',
      ...
      'wechat_qr_alt' => 'WeChat QR login',
      'wechat_login' => 'WeChat login',
      'google_methods' => 'Google login',
      'google_signin' => 'Continue with Google',
    ],
    'zh-hans' => [
      'sign_in' => '统一登录',
      'unified_login' => '统一登录',
      'unified_login_sub' => '一个身份入口，覆盖全国与海外',
      ...
      'company_label' => '企业',
      'sign_up' => '邮箱首次登录即注册',
      'account_auto_hint' => '已有账号直接登录；新邮箱将自动注册。',
      'reset_password' => '重置密码',
      'login_alt' => '登录',
      'log_in' => '登录',
      ...
      'qr_fail' => '二维码加载失败',
      'wechat_qr_alt' => '微信扫码登录',
      'wechat_login' => '微信登录',
      'google_methods' => 'Google 登录',
      'google_signin' => '使用 Google 继续',
    ],
    'zh-hant' => [
      'sign_in' => '統一登入',
      'unified_login' => '統一登入',
      'unified_login_sub' => '一個身分入口，覆蓋全國與海外',
      ...
      'network_error' => '網路錯誤',
      'sign_up' => '郵箱首次登入即註冊',
      'account_auto_hint' => '已有帳號直接登入；新郵箱將自動註冊。',
      'reset_password' => '重設密碼',
      'login_alt' => '登入',
      'log_in' => '登入',
      ...
      'qr_fail' => '二維碼載入失敗',
      'wechat_qr_alt' => '微信掃碼登入',
      'wechat_login' => '微信登入',
      'google_methods' => 'Google 登入',
      'google_signin' => '使用 Google 繼續',
      'enterprise_header_sub' => '使用市場監督管理局統一社會信用代碼登入',
      'enterprise_your_id' => '企業信用代碼',
      'enterprise_password' => '登入密碼',
      'enterprise_pass_hint' => '使用已綁定該企業的帳號密碼。',
      'enterprise_submit' => '企業ID登入',
      'enterprise_footnote' => '管理員可在「配置 → 企業登入」綁定信用代碼與帳號。',
      'wechat_short' => '微信',
      'mobile_short' => '手機',
      'account_short' => '帳號',
      'back_to_methods' => '返回',
      'in_wechat' => '偵測到微信環境',
      'wechat_signin' => '微信一鍵登入',
      'wechat_authorize' => '授權後即可快速登入',
      'csrf_error' => '登入工作階段已過期，請重新整理後重試',
    ],
  ];
