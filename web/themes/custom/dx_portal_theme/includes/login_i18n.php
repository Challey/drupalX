...
function dx_portal_theme_login_i18n_strings($langcode = NULL) {
  ...
  $catalog = [
    'en' => [
      ...
      'enter_mobile_code' => 'Please enter mobile number and verification code.',
      'code_sent' => 'Verification code sent.',
      'code_sent_test' => 'Test-mode code',
    ],
    'zh-hans' => [
      'sign_in' => '登录',
      ...
      'enter_mobile_code' => '请输入手机号码和验证码',
      'code_sent' => '验证码已发送',
      'code_sent_test' => '测试模式验证码',
    ],
    'zh-hant' => [
      'sign_in' => '登入',
      ...
      'send_code' => '發送驗證碼',
      'resend_in' => '重新發送',
      'enter_mobile' => '請輸入手機號碼',
      'enter_mobile_code' => '請輸入手機號碼和驗證碼',
      'code_sent' => '驗證碼已發送',
      'code_sent_test' => '測試模式驗證碼',
    ],
  ];
