...
function dx_portal_theme_login_i18n_strings($langcode = NULL) {
  ...
  $catalog = [
    'en' => [
      ...
      'lookup_ok' => 'Enterprise recognized. Enter the bound account password.',
      'unbound_hint' => 'This enterprise is not bound to a login account yet. Ask an admin to bind it.',
      'portal_hint' => 'This enterprise has a dedicated portal. You will be redirected after sign-in.',
    ...
    'zh-hans' => [
      ...
      'not_found' => '未找到该企业ID。',
      'lookup_ok' => '已识别企业，请输入绑定账号密码登录。',
      'unbound_hint' => '该企业尚未绑定登录账号，请联系管理员绑定。',
      'portal_hint' => '该企业有专属门户，登录后将引导前往门户。',
      'signing_in' => '正在登录…',
      'mobile_number' => '手机号码',
    ...
    'zh-hant' => [
      ...
      'not_found' => '未找到該企業ID。',
      'lookup_ok' => '已識別企業，請輸入綁定帳號密碼登入。',
      'unbound_hint' => '該企業尚未綁定登入帳號，請聯繫管理員綁定。',
      'portal_hint' => '該企業有專屬門戶，登入後將引導前往門戶。',
      'signing_in' => '正在登入…',
      'csrf_error' => '登入工作階段已過期，請重新整理頁面後再試',
      'mobile_number' => '手機號碼',
