...
use Drupal\dx_appstore\RevenueShareListBuilder;
...
#[ContentEntityType(
  ...
  links: [
    'collection' => '/admin/dx/appstore/revenue',
    'add-form' => '/admin/dx/appstore/revenue/add',
    'edit-form' => '/admin/dx/appstore/revenue/{dx_revenue_share}/edit',
    'delete-form' => '/admin/dx/appstore/revenue/{dx_revenue_share}/delete',
  ],
  admin_permission: 'administer dx appstore',
  base_table: 'dx_revenue_share',
  label_count: [
...
class RevenueShare extends ContentEntityBase {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type): array {
    ...
    $fields['license_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setSetting('target_type', 'dx_license')
      ->setRequired(TRUE);
