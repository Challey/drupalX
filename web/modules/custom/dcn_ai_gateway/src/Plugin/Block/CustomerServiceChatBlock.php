...
namespace Drupal\dcn_ai_gateway\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "dcn_customer_service_chat",
 *   admin_label = @Translation("DCN Customer Service Chat"),
...
class CustomerServiceChatBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build(): array {
    return [
      ...
      '#endpoint' => Url::fromRoute('dcn_ai_gateway.chat')->toString(),
      '#attached' => [
        'library' => ['dcn_ai_gateway/chat'],
      ],
    ];
  }
