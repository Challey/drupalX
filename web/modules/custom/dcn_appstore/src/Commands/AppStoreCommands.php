...
namespace Drupal\dcn_appstore\Commands;
...
class AppStoreCommands extends DrushCommands {
   ...
   *
   * @command dcn:appstore-seed
   * @aliases dcn-as
   * @usage drush dcn:appstore-seed
   */
  public function appstoreSeed(): void {
    $path = DRUPAL_ROOT . '/modules/custom/dcn_appstore/data/catalog.yml';
    if (!is_readable($path)) {
    ...
    foreach ($apps as $app) {
      ...
      /** @var \Drupal\dcn_appstore\Entity\AppPackage $entity */
