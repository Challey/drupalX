...
> 产品名：**DrupalX**（`dx_*` / `DX_*`）  
> 运维落地：[channel.md](channel.md)（`dx_channel` 端点 / token / 冒烟）  
> 关联：[turnkey-delivery.md](turnkey-delivery.md) · [strategy.md](strategy.md) · [architecture.md](architecture.md) · [module-curation.md](module-curation.md) · [decisions.md](decisions.md) · [README.md](README.md)
