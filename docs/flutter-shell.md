...
> 日期：2026-08-16  
> 产品名：**DrupalX**（`dx_*` / `DX_*`）  
> 运维落地：[flutter-pack.md](flutter-pack.md) · [packer-pipeline.md](packer-pipeline.md) · [channel.md](channel.md) · [certs.md](certs.md)  
> 关联：[decisions.md](decisions.md)（D3-B / D10-B）· [data-exchange.md](data-exchange.md)（DXEP）· [turnkey-delivery.md](turnkey-delivery.md) · [README.md](README.md)  
