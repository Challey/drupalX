...
> 设计稿：[open-ecosystem.md](open-ecosystem.md)（2026-08-17）  
> 推荐默认：`O1-B, O2-A, O3-A, O4-A, O5-A, O6-A, O7-A, O8-A`
...
- [ ] **A** `tenant_kind=personal` 预留、默认关闭（推荐）  
- [ ] **B** 同期开放个人注册  

### O7 · 确认后开工顺序

- [ ] **A** OE1 协议 → OE2 金库 → OE3 公开面（推荐）  
- [ ] **B** 先 OE3  
- [ ] **C** 先 OE4 personal  
...
| 日期 | 2026-08-16 |
| 开源生态（D 区） | **待确认** — 回复 `OE 全默认` 或逐项 O1–O8 |

交钥匙主线已按 D16-A 推进。开源生态确认后按 O7 启动 Phase OE。
